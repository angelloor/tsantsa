...
import { assistanceRoutes } from './assistance.routing';
import { AssistanceListComponent } from './list/list.component';
import { ModalAssistanceDetailsComponent } from './modal-assistance/modal-assistance-details/modal-assistance-details.component';
...
@NgModule({
  declarations: [
    ...
    ModalAssistanceDetailsComponent,
  ],
  imports: [
    RouterModule.forChild(assistanceRoutes),
    MatButtonModule,
    MatCheckboxModule,
    MatDatepickerModule,
    MatDividerModule,
