...
import { ModalUserTaskService } from './modal-user-task.service';
...
export class ModalUserTaskComponent implements OnInit {
   ...
   */
  ngOnInit(): void {
    this.id_user_task = this._data.id_user_task;
    /**
     * isOpenModal
     */
    ...
    this._userTaskService
      .readUserTaskByIdLocal(this.id_user_task)
      .pipe(takeUntil(this._unsubscribeAll))
      .subscribe();
    /**
     * Get the userTasks
  ...
  changeIsOpen(): void {
    ...
    userTask = {
      ...
      is_open: true,
      qualification_user_task: parseInt(userTask.qualification_user_task),
    };
  ...
  closeModalUserTask(): void {
    this._modalUserTaskService.closeModalUserTask();
  }
  /**
